...
Void FlxSplash_obj::create( ){
{
		...
		HX_STACK_LINE(52)
		{
			...
			while((true)){
				...
				++(_g);
				HX_STACK_LINE(54)
				::flixel::util::FlxTimer tmp14 = ::flixel::util::FlxTimer_obj::__new(null());		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(54)
		...
		HX_STACK_LINE(76)
		tmp38->__Field(HX_HCSTRING("play","\xf4","\x2d","\x5a","\x4a"), hx::paccDynamic )(null(),null(),null());
	}
return null();
}
