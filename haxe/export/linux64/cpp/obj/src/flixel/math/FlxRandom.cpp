...
Float FlxRandom_obj::generate( ){
	HX_STACK_FRAME("flixel.math.FlxRandom","generate",0xe00ed5a2,"flixel.math.FlxRandom.generate","flixel/math/FlxRandom.hx",402,0x4fa37e1d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(403)
...
int FlxRandom_obj::set_initialSeed( int NewSeed){
	HX_STACK_FRAME("flixel.math.FlxRandom","set_initialSeed",0x5f4b69eb,"flixel.math.FlxRandom.set_initialSeed","flixel/math/FlxRandom.hx",417,0x4fa37e1d)
	HX_STACK_THIS(this)
...
int FlxRandom_obj::get_currentSeed( ){
	HX_STACK_FRAME("flixel.math.FlxRandom","get_currentSeed",0xbfecf714,"flixel.math.FlxRandom.get_currentSeed","flixel/math/FlxRandom.hx",425,0x4fa37e1d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(426)
	Float tmp = this->internalSeed;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(426)
...
int FlxRandom_obj::set_currentSeed( int NewSeed){
	HX_STACK_FRAME("flixel.math.FlxRandom","set_currentSeed",0xbbb87420,"flixel.math.FlxRandom.set_currentSeed","flixel/math/FlxRandom.hx",433,0x4fa37e1d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(NewSeed,"NewSeed")
	HX_STACK_LINE(434)
...
int FlxRandom_obj::rangeBound( int Value){
	HX_STACK_FRAME("flixel.math.FlxRandom","rangeBound",0x5cf038ee,"flixel.math.FlxRandom.rangeBound","flixel/math/FlxRandom.hx",441,0x4fa37e1d)
