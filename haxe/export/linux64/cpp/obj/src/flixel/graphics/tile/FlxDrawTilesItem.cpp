...
int FlxDrawTilesItem_obj::get_numVertices( ){
	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","get_numVertices",0x8b0e8f99,"flixel.graphics.tile.FlxDrawTilesItem.get_numVertices","flixel/graphics/tile/FlxDrawTilesItem.hx",122,0xdffe6dcc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(123)
...
int FlxDrawTilesItem_obj::get_numTriangles( ){
	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","get_numTriangles",0x37fe0d0b,"flixel.graphics.tile.FlxDrawTilesItem.get_numTriangles","flixel/graphics/tile/FlxDrawTilesItem.hx",127,0xdffe6dcc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(128)
	int tmp = this->get_numTiles();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(128)
