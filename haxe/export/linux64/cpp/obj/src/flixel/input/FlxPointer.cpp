...
::flixel::math::FlxPoint FlxPointer_obj::getWorldPosition( ::flixel::FlxCamera Camera,::flixel::math::FlxPoint point){
	...
	HX_STACK_LINE(40)
	::flixel::math::FlxPoint tmp3 = ::flixel::input::FlxPointer_obj::_cachedPoint;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(40)
	this->getScreenPosition(tmp2,tmp3);
	HX_STACK_LINE(41)
	::flixel::math::FlxPoint tmp4 = ::flixel::input::FlxPointer_obj::_cachedPoint;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(41)
	...
	point->set_x(tmp7);
	HX_STACK_LINE(42)
	::flixel::math::FlxPoint tmp8 = ::flixel::input::FlxPointer_obj::_cachedPoint;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(42)
...
Void FlxPointer_obj::updatePositions( ){
{
		...
		HX_STACK_LINE(142)
		::flixel::math::FlxPoint tmp1 = ::flixel::input::FlxPointer_obj::_cachedPoint;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(142)
		this->getScreenPosition(tmp,tmp1);
		HX_STACK_LINE(143)
		::flixel::math::FlxPoint tmp2 = ::flixel::input::FlxPointer_obj::_cachedPoint;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(143)
		...
		this->screenX = tmp4;
		HX_STACK_LINE(144)
		::flixel::math::FlxPoint tmp5 = ::flixel::input::FlxPointer_obj::_cachedPoint;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(144)
		...
		HX_STACK_LINE(146)
		::flixel::math::FlxPoint tmp9 = ::flixel::input::FlxPointer_obj::_cachedPoint;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(146)
		this->getWorldPosition(tmp8,tmp9);
		HX_STACK_LINE(147)
		::flixel::math::FlxPoint tmp10 = ::flixel::input::FlxPointer_obj::_cachedPoint;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(147)
		...
		this->x = tmp12;
		HX_STACK_LINE(148)
		::flixel::math::FlxPoint tmp13 = ::flixel::input::FlxPointer_obj::_cachedPoint;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(148)
...
{
	_cachedPoint= ::flixel::math::FlxPoint_obj::__new(null(),null());
}
