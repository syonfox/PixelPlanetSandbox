...
struct _Function_0_1{
	inline static Dynamic Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",108,0x5edd1803)
		{
			...
			struct _Function_1_1{
				inline static Dynamic Block( ){
					...
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_HCSTRING("SuppressWarnings","\x0c","\xd3","\xd2","\x00") , cpp::ArrayBase_obj::__new().Add(HX_HCSTRING("checkstyle:MemberName","\xd6","\x25","\x7e","\xc4")),false);
						return __result;
					}
					return null();
				}
