...
struct _Function_0_1{
	inline static ::flixel::input::gamepad::FlxGamepadAnalogStick Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/MayflashWiiRemoteID.hx",81,0xf531935f)
		{
...
struct _Function_0_2{
	inline static ::flixel::input::gamepad::FlxGamepadAnalogStick Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/MayflashWiiRemoteID.hx",90,0xf531935f)
		{
			struct _Function_1_1{
				inline static Dynamic Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/MayflashWiiRemoteID.hx",90,0xf531935f)
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_HCSTRING("up","\x5b","\x66","\x00","\x00") , (int)26,false);
						__result->Add(HX_HCSTRING("down","\x62","\xf8","\x6d","\x42") , (int)27,false);
						__result->Add(HX_HCSTRING("left","\x07","\x08","\xb0","\x47") , (int)28,false);
						__result->Add(HX_HCSTRING("right","\xdc","\x0b","\x64","\xe9") , (int)29,false);
						return __result;
					}
					return null();
				}
	...
	LEFT_ANALOG_STICK= _Function_0_2::Block();
struct _Function_0_3{
	inline static ::flixel::input::gamepad::FlxGamepadAnalogStick Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/MayflashWiiRemoteID.hx",91,0xf531935f)
		{
			struct _Function_1_1{
				inline static Dynamic Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/MayflashWiiRemoteID.hx",91,0xf531935f)
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_HCSTRING("up","\x5b","\x66","\x00","\x00") , (int)30,false);
						__result->Add(HX_HCSTRING("down","\x62","\xf8","\x6d","\x42") , (int)31,false);
						__result->Add(HX_HCSTRING("left","\x07","\x08","\xb0","\x47") , (int)32,false);
						__result->Add(HX_HCSTRING("right","\xdc","\x0b","\x64","\xe9") , (int)33,false);
						return __result;
					}
					return null();
				}
			...
			Dynamic tmp = _Function_1_1::Block();		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(91)
			return ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)2,(int)3,tmp);
		}
		return null();
	}
};
	RIGHT_ANALOG_STICK= _Function_0_3::Block();
