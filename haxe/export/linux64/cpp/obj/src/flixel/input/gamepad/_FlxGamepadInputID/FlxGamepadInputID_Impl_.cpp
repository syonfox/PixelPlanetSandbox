...
::String FlxGamepadInputID_Impl__obj::toString( int this1){
	HX_STACK_FRAME("flixel.input.gamepad._FlxGamepadInputID.FlxGamepadInputID_Impl_","toString",0xe73bb9d8,"flixel.input.gamepad._FlxGamepadInputID.FlxGamepadInputID_Impl_.toString","flixel/input/gamepad/FlxGamepadInputID.hx",120,0x292d23ae)
...
struct _Function_0_1{
	inline static ::haxe::ds::StringMap Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/macros/FlxMacroUtil.hx",53,0x8cc0f087)
		{
			...
			HX_STACK_LINE(53)
			_g->set(HX_HCSTRING("LEFT_STICK_DIGITAL_UP","\x29","\xd8","\x3b","\xd5"),(int)34);
			HX_STACK_LINE(53)
			_g->set(HX_HCSTRING("LEFT_STICK_DIGITAL_RIGHT","\xae","\xca","\x36","\x04"),(int)35);
			HX_STACK_LINE(53)
			_g->set(HX_HCSTRING("LEFT_STICK_DIGITAL_DOWN","\xb0","\xdd","\xc3","\x72"),(int)36);
			HX_STACK_LINE(53)
			_g->set(HX_HCSTRING("LEFT_STICK_DIGITAL_LEFT","\x55","\xed","\x05","\x78"),(int)37);
			HX_STACK_LINE(53)
			_g->set(HX_HCSTRING("RIGHT_STICK_DIGITAL_UP","\xd4","\xe8","\x30","\xf8"),(int)38);
			HX_STACK_LINE(53)
			_g->set(HX_HCSTRING("RIGHT_STICK_DIGITAL_RIGHT","\xe3","\x36","\xd3","\x6c"),(int)39);
			HX_STACK_LINE(53)
			_g->set(HX_HCSTRING("RIGHT_STICK_DIGITAL_DOWN","\x1b","\xaf","\x9e","\x09"),(int)40);
			HX_STACK_LINE(53)
			_g->set(HX_HCSTRING("RIGHT_STICK_DIGITAL_LEFT","\xc0","\xbe","\xe0","\x0e"),(int)41);
			HX_STACK_LINE(53)
			return _g;
		}
		return null();
...
struct _Function_0_2{
	inline static ::haxe::ds::IntMap Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/macros/FlxMacroUtil.hx",53,0x8cc0f087)
		{
			...
			HX_STACK_LINE(53)
			_g->set((int)34,HX_HCSTRING("LEFT_STICK_DIGITAL_UP","\x29","\xd8","\x3b","\xd5"));
			HX_STACK_LINE(53)
			_g->set((int)35,HX_HCSTRING("LEFT_STICK_DIGITAL_RIGHT","\xae","\xca","\x36","\x04"));
			HX_STACK_LINE(53)
			_g->set((int)36,HX_HCSTRING("LEFT_STICK_DIGITAL_DOWN","\xb0","\xdd","\xc3","\x72"));
			HX_STACK_LINE(53)
			_g->set((int)37,HX_HCSTRING("LEFT_STICK_DIGITAL_LEFT","\x55","\xed","\x05","\x78"));
			HX_STACK_LINE(53)
			_g->set((int)38,HX_HCSTRING("RIGHT_STICK_DIGITAL_UP","\xd4","\xe8","\x30","\xf8"));
			HX_STACK_LINE(53)
			_g->set((int)39,HX_HCSTRING("RIGHT_STICK_DIGITAL_RIGHT","\xe3","\x36","\xd3","\x6c"));
			HX_STACK_LINE(53)
			_g->set((int)40,HX_HCSTRING("RIGHT_STICK_DIGITAL_DOWN","\x1b","\xaf","\x9e","\x09"));
			HX_STACK_LINE(53)
			_g->set((int)41,HX_HCSTRING("RIGHT_STICK_DIGITAL_LEFT","\xc0","\xbe","\xe0","\x0e"));
			HX_STACK_LINE(53)
			return _g;
		}
		return null();
	...
	EXTRA_2= (int)32;
	EXTRA_3= (int)33;
	LEFT_STICK_DIGITAL_UP= (int)34;
	LEFT_STICK_DIGITAL_RIGHT= (int)35;
	LEFT_STICK_DIGITAL_DOWN= (int)36;
	LEFT_STICK_DIGITAL_LEFT= (int)37;
	RIGHT_STICK_DIGITAL_UP= (int)38;
	RIGHT_STICK_DIGITAL_RIGHT= (int)39;
	RIGHT_STICK_DIGITAL_DOWN= (int)40;
	RIGHT_STICK_DIGITAL_LEFT= (int)41;
}
