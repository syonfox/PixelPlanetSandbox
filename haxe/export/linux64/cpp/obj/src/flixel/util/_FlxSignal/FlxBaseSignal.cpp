...
{
		HX_STACK_FRAME("flixel.util._FlxSignal.FlxBaseSignal","add",0x245ee4c5,"flixel.util._FlxSignal.FlxBaseSignal.add","flixel/util/FlxSignal.hx",113,0x3c758c5e)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.util._FlxSignal.FlxBaseSignal","addOnce",0xaa1cd4e6,"flixel.util._FlxSignal.FlxBaseSignal.addOnce","flixel/util/FlxSignal.hx",119,0x3c758c5e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(120)
		bool tmp = (listener != null());		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("flixel.util._FlxSignal.FlxBaseSignal","remove",0x06fde820,"flixel.util._FlxSignal.FlxBaseSignal.remove","flixel/util/FlxSignal.hx",125,0x3c758c5e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(126)
		bool tmp = (listener != null());		HX_STACK_VAR(tmp,"tmp");
