...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/btn_gor_32x64.png", __ASSET__assets_images_btn_gor_32x64_png);
		...
		className.set ("assets/images/btn_gor_32x32.png", __ASSET__assets_images_btn_gor_32x32_png);
		type.set ("assets/images/btn_gor_32x32.png", AssetType.IMAGE);
		className.set ("assets/images/btn_gwr_100x20.png", __ASSET__assets_images_btn_gwr_100x20_png);
		type.set ("assets/images/btn_gwr_100x20.png", AssetType.IMAGE);
		className.set ("assets/images/btn_gor_32x128.png", __ASSET__assets_images_btn_gor_32x128_png);
		type.set ("assets/images/btn_gor_32x128.png", AssetType.IMAGE);
		className.set ("assets/images/btn_gbr_100x20.png", __ASSET__assets_images_btn_gbr_100x20_png);
		type.set ("assets/images/btn_gbr_100x20.png", AssetType.IMAGE);
		className.set ("assets/data/data-goes-here.txt", __ASSET__assets_data_data_goes_here_txt);
		type.set ("assets/data/data-goes-here.txt", AssetType.TEXT);
		className.set ("assets/fonts/Hack-Regular.svg", __ASSET__assets_fonts_hack_regular_svg);
		...
		className.set ("assets/fonts/Hack-Regular.eot", __ASSET__assets_fonts_hack_regular_eot);
		type.set ("assets/fonts/Hack-Regular.eot", AssetType.BINARY);
		className.set ("assets/fonts/Hack-Regular.woff", __ASSET__assets_fonts_hack_regular_woff);
		...
		className.set (id, __ASSET__assets_fonts_hack_regular_ttf);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_btn_gor_32x64_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_btn_gor_32x32_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_btn_gwr_100x20_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_btn_gor_32x128_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_btn_gbr_100x20_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_data_data_goes_here_txt extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_hack_regular_svg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_hack_regular_ttf extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_hack_regular_eot extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_hack_regular_woff extends null { }
...
@:image("assets/images/btn_gor_32x64.png") #if display private #end class __ASSET__assets_images_btn_gor_32x64_png extends lime.graphics.Image {}
...
@:image("assets/images/btn_gor_32x32.png") #if display private #end class __ASSET__assets_images_btn_gor_32x32_png extends lime.graphics.Image {}
@:image("assets/images/btn_gwr_100x20.png") #if display private #end class __ASSET__assets_images_btn_gwr_100x20_png extends lime.graphics.Image {}
@:image("assets/images/btn_gor_32x128.png") #if display private #end class __ASSET__assets_images_btn_gor_32x128_png extends lime.graphics.Image {}
@:image("assets/images/btn_gbr_100x20.png") #if display private #end class __ASSET__assets_images_btn_gbr_100x20_png extends lime.graphics.Image {}
@:file("assets/data/data-goes-here.txt") #if display private #end class __ASSET__assets_data_data_goes_here_txt extends lime.utils.Bytes {}
@:file("assets/fonts/Hack-Regular.svg") #if display private #end class __ASSET__assets_fonts_hack_regular_svg extends lime.utils.Bytes {}
@:font("assets/fonts/Hack-Regular.ttf") #if display private #end class __ASSET__assets_fonts_hack_regular_ttf extends lime.text.Font {}
@:file("assets/fonts/Hack-Regular.eot") #if display private #end class __ASSET__assets_fonts_hack_regular_eot extends lime.utils.Bytes {}
@:file("assets/fonts/Hack-Regular.woff") #if display private #end class __ASSET__assets_fonts_hack_regular_woff extends lime.utils.Bytes {}
@:file("assets/music/music-goes-here.txt") #if display private #end class __ASSET__assets_music_music_goes_here_txt extends lime.utils.Bytes {}
@:file("assets/sounds/sounds-go-here.txt") #if display private #end class __ASSET__assets_sounds_sounds_go_here_txt extends lime.utils.Bytes {}
@:file("/home/syonfox/haxelib/flixel/4,2,0/assets/sounds/beep.ogg") #if display private #end class __ASSET__flixel_sounds_beep_ogg extends lime.utils.Bytes {}
@:file("/home/syonfox/haxelib/flixel/4,2,0/assets/sounds/flixel.ogg") #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends lime.utils.Bytes {}
...
@:file("/home/syonfox/haxelib/flixel-ui/2,2,0/assets/xml/default_loading_screen.xml") #if display private #end class __ASSET__flixel_flixel_ui_xml_default_loading_screen_xml extends lime.utils.Bytes {}
@:file("/home/syonfox/haxelib/flixel-ui/2,2,0/assets/xml/default_popup.xml") #if display private #end class __ASSET__flixel_flixel_ui_xml_default_popup_xml extends lime.utils.Bytes {}
@:file("/home/syonfox/haxelib/flixel-ui/2,2,0/assets/xml/defaults.xml") #if display private #end class __ASSET__flixel_flixel_ui_xml_defaults_xml extends lime.utils.Bytes {}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_hack_regular_ttf extends openfl.text.Font { public function new () { var font = new __ASSET__assets_fonts_hack_regular_ttf (); src = font.src; name = font.name; super (); }}
