...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/btn_gwr_100x20.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/btn_gbr_100x20.png", Reflect.field (AssetType, "image".toUpperCase ()));
