...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::__ASSET__flixel_images_logo_default_png_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< __ASSET__flixel_images_logo_default_png_obj > _result_ = new __ASSET__flixel_images_logo_default_png_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap___ASSET__flixel_images_logo_default_png","\x85","\xa1","\x73","\x91");
}
