...
bool FlxNode_obj::canPlace( int width,int height){
	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","canPlace",0xb6bfba85,"flixel.graphics.atlas.FlxNode.canPlace","flixel/graphics/atlas/FlxNode.hx",98,0x6d18bb9f)
	HX_STACK_THIS(this)
...
::flixel::graphics::frames::FlxTileFrames FlxNode_obj::getTileFrames( ::flixel::math::FlxPoint tileSize,::flixel::math::FlxPoint tileSpacing,::flixel::math::FlxPoint tileBorder){
	...
	HX_STACK_LINE(111)
	tmp->__Field(HX_HCSTRING("add","\x21","\xf2","\x49","\x00"), hx::paccDynamic )(tmp2,false,tmp4);
	HX_STACK_LINE(112)
	::flixel::graphics::frames::FlxFrame tmp5;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(112)
	{
		HX_STACK_LINE(112)
		::flixel::graphics::atlas::FlxAtlas tmp6 = this->atlas;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(112)
		::flixel::graphics::frames::FlxAtlasFrames tmp7 = tmp6->getAtlasFrames();		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(112)
		::flixel::graphics::frames::FlxAtlasFrames _this = tmp7;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(112)
		::String tmp8 = this->key;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(112)
		::flixel::graphics::frames::FlxFrame tmp9 = _this->framesHash->get(tmp8);		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(112)
		tmp5 = tmp9;
	}
	HX_STACK_LINE(112)
	::flixel::graphics::frames::FlxFrame frame = tmp5;		HX_STACK_VAR(frame,"frame");
	HX_STACK_LINE(114)
	bool tmp6 = (frame != null());		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(114)
	if ((tmp6)){
		HX_STACK_LINE(116)
		::flixel::graphics::frames::FlxFrame tmp7 = frame;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(116)
		::flixel::math::FlxPoint tmp8 = tileSize;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(116)
		::flixel::math::FlxPoint tmp9 = tileSpacing;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(116)
		::flixel::graphics::frames::FlxTileFrames tmp10 = ::flixel::graphics::frames::FlxTileFrames_obj::fromFrame(tmp7,tmp8,tmp9);		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(116)
		::flixel::graphics::frames::FlxTileFrames tileFrames = tmp10;		HX_STACK_VAR(tileFrames,"tileFrames");
		HX_STACK_LINE(117)
		bool tmp11 = (tileBorder != null());		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(117)
		if ((tmp11)){
			HX_STACK_LINE(119)
			::flixel::math::FlxPoint tmp12 = tileBorder;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(119)
			::flixel::graphics::frames::FlxTileFrames tmp13 = hx::TCast< ::flixel::graphics::frames::FlxTileFrames >::cast(tileFrames->addBorder(tmp12));		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(119)
			tileFrames = tmp13;
		}
		HX_STACK_LINE(121)
		::flixel::graphics::frames::FlxTileFrames tmp12 = tileFrames;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(121)
		return tmp12;
	}
	HX_STACK_LINE(124)
...
::flixel::graphics::frames::FlxImageFrame FlxNode_obj::getImageFrame( ){
	...
	if ((tmp6)){
		...
		::flixel::graphics::frames::FlxFrame tmp7 = frame;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(138)
		::flixel::graphics::frames::FlxImageFrame tmp8 = ::flixel::graphics::frames::FlxImageFrame_obj::fromFrame(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(138)
		return tmp8;
	}
	HX_STACK_LINE(141)
