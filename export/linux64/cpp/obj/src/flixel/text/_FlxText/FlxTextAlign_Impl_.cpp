...
::String FlxTextAlign_Impl__obj::fromOpenFL( ::String align){
	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","fromOpenFL",0xc584ea03,"flixel.text._FlxText.FlxTextAlign_Impl_.fromOpenFL","flixel/text/FlxText.hx",1123,0xdf165a6e)
...
::String FlxTextAlign_Impl__obj::toOpenFL( ::String align){
	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","toOpenFL",0xa34e3094,"flixel.text._FlxText.FlxTextAlign_Impl_.toOpenFL","flixel/text/FlxText.hx",1135,0xdf165a6e)
	HX_STACK_ARG(align,"align")
	HX_STACK_LINE(1136)
	::String tmp = align;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(1136)
