...
{
		HX_STACK_FRAME("flixel.util.LabelValuePair","put",0x8e76c772,"flixel.util.LabelValuePair.put","flixel/util/FlxStringUtil.hx",622,0x4e012e33)
		HX_STACK_THIS(this)
		HX_STACK_LINE(623)
...
::flixel::util::LabelValuePair LabelValuePair_obj::weak( ::String label,Dynamic value){
	HX_STACK_FRAME("flixel.util.LabelValuePair","weak",0x1e0c0675,"flixel.util.LabelValuePair.weak","flixel/util/FlxStringUtil.hx",607,0x4e012e33)
	HX_STACK_ARG(label,"label")
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(608)
