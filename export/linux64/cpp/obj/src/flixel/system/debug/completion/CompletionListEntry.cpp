...
Void CompletionListEntry_obj::setItem( ::String item){
{
		...
		tmp->set_text(tmp1);
		HX_STACK_LINE(51)
		::openfl::_legacy::text::TextField tmp2 = this->label;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(51)
		Float tmp3 = tmp2->get_width();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(51)
		bool tmp4 = (tmp3 > (int)150);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(51)
		if ((tmp4)){
			HX_STACK_LINE(53)
			::openfl::_legacy::text::TextField tmp5 = this->label;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(53)
			tmp5->set_width((int)150);
			HX_STACK_LINE(54)
			::openfl::_legacy::text::TextField tmp6 = this->label;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(54)
			tmp6->set_autoSize(::openfl::_legacy::text::TextFieldAutoSize_obj::NONE);
		}
	}
return null();
}
