...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_system::debug::GraphicCloseButton_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_system_debug_GraphicCloseButton","\x21","\x6c","\xf7","\x70");
}
