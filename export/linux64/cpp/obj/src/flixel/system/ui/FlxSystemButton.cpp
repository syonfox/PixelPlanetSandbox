...
{
		HX_STACK_FRAME("flixel.system.ui.FlxSystemButton","onMouseOver",0x7ce209b2,"flixel.system.ui.FlxSystemButton.onMouseOver","flixel/system/ui/FlxSystemButton.hx",114,0x167fa379)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(115)
		bool tmp = this->enabled;		HX_STACK_VAR(tmp,"tmp");
		...
		if ((tmp)){
			...
			HX_STACK_LINE(116)
			Float tmp1 = _g->__Field(HX_HCSTRING("get_alpha","\xb5","\x03","\x40","\x65"), hx::paccDynamic )();		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(116)
			Float tmp2 = (tmp1 - ((Float)0.2));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(116)
			_g->__Field(HX_HCSTRING("set_alpha","\xc1","\xef","\x90","\x48"), hx::paccDynamic )(tmp2);
		}
	}
return null();
}
