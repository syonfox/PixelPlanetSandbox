...
HX_STACK_ARG(sources,"sources")
{
	...
	if ((tmp6)){
		...
		HX_STACK_LINE(35)
		Dynamic tmp10 = hx::SourceInfo(HX_HCSTRING("Shader.hx","\x99","\xa8","\x0b","\xd1"),35,HX_HCSTRING("flixel.effects.postprocess.Shader","\xc2","\xfc","\xed","\x12"),HX_HCSTRING("new","\x60","\xd0","\x53","\x00"));		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(35)
		...
		HX_STACK_LINE(36)
		Dynamic tmp15 = hx::SourceInfo(HX_HCSTRING("Shader.hx","\x99","\xa8","\x0b","\xd1"),36,HX_HCSTRING("flixel.effects.postprocess.Shader","\xc2","\xfc","\xed","\x12"),HX_HCSTRING("new","\x60","\xd0","\x53","\x00"));		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(36)
		...
		HX_STACK_LINE(37)
		Dynamic tmp18 = hx::SourceInfo(HX_HCSTRING("Shader.hx","\x99","\xa8","\x0b","\xd1"),37,HX_HCSTRING("flixel.effects.postprocess.Shader","\xc2","\xfc","\xed","\x12"),HX_HCSTRING("new","\x60","\xd0","\x53","\x00"));		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(37)
...
::openfl::_legacy::gl::GLShader Shader_obj::compile( ::String source,int type){
	...
	if ((tmp6)){
		...
		HX_STACK_LINE(55)
		Dynamic tmp9 = hx::SourceInfo(HX_HCSTRING("Shader.hx","\x99","\xa8","\x0b","\xd1"),55,HX_HCSTRING("flixel.effects.postprocess.Shader","\xc2","\xfc","\xed","\x12"),HX_HCSTRING("compile","\x73","\x25","\x6f","\x83"));		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(55)
...
int Shader_obj::attribute( ::String a){
	HX_STACK_FRAME("flixel.effects.postprocess.Shader","attribute",0xffa03d70,"flixel.effects.postprocess.Shader.attribute","flixel/effects/postprocess/Shader.hx",67,0x282d2ed9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(68)
...
int Shader_obj::uniform( ::String u){
	HX_STACK_FRAME("flixel.effects.postprocess.Shader","uniform",0xc2b05188,"flixel.effects.postprocess.Shader.uniform","flixel/effects/postprocess/Shader.hx",76,0x282d2ed9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(u,"u")
	HX_STACK_LINE(77)
	::openfl::_legacy::gl::GLProgram tmp = this->program;		HX_STACK_VAR(tmp,"tmp");
