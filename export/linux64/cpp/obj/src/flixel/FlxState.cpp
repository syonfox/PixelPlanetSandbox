...
Void FlxState_obj::resetSubState( ){
{
		...
		if ((tmp4)){
			...
			HX_STACK_LINE(115)
			tmp7->_parentState = hx::ObjectPtr<OBJ_>(this);
			HX_STACK_LINE(117)
			::flixel::FlxSubState tmp8 = this->subState;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(117)
			bool tmp9 = tmp8->_created;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(117)
...
int FlxState_obj::get_bgColor( ){
	HX_STACK_FRAME("flixel.FlxState","get_bgColor",0xc8234a38,"flixel.FlxState.get_bgColor","flixel/FlxState.hx",187,0xdf96844c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(188)
...
int FlxState_obj::set_bgColor( int Value){
	HX_STACK_FRAME("flixel.FlxState","set_bgColor",0xd2905144,"flixel.FlxState.set_bgColor","flixel/FlxState.hx",193,0xdf96844c)
	HX_STACK_THIS(this)
