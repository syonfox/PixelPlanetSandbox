...
::flixel::math::FlxRect FlxRect_obj::intersection( ::flixel::math::FlxRect rect,::flixel::math::FlxRect result){
	...
	HX_STACK_LINE(375)
	Float x0 = tmp4;		HX_STACK_VAR(x0,"x0");
	HX_STACK_LINE(376)
	...
	HX_STACK_LINE(376)
	Float x1 = tmp10;		HX_STACK_VAR(x1,"x1");
	HX_STACK_LINE(377)
	bool tmp11 = (x1 <= x0);		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(377)
	if ((tmp11)){
		HX_STACK_LINE(379)
		{
			HX_STACK_LINE(379)
			bool tmp12 = rect->_weak;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(379)
			if ((tmp12)){
				HX_STACK_LINE(379)
				bool tmp13 = rect->_inPool;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(379)
				...
				if ((tmp14)){
					...
					rect->_weak = false;
					HX_STACK_LINE(379)
					::flixel::util::FlxPool_flixel_math_FlxRect tmp15 = ::flixel::math::FlxRect_obj::_pool;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(379)
					::flixel::math::FlxRect tmp16 = rect;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(379)
					tmp15->putUnsafe(tmp16);
				}
			}
		}
		HX_STACK_LINE(380)
		::flixel::math::FlxRect tmp12 = result;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(380)
		return tmp12;
	}
	HX_STACK_LINE(383)
	...
	HX_STACK_LINE(383)
	Float tmp13 = rect->y;		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(383)
	...
	HX_STACK_LINE(384)
	Float tmp17 = this->height;		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(384)
	Float tmp18 = (tmp16 + tmp17);		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(384)
	Float tmp19 = (rect->y + rect->height);		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(384)
	...
	HX_STACK_LINE(385)
	bool tmp22 = (y1 <= y0);		HX_STACK_VAR(tmp22,"tmp22");
	HX_STACK_LINE(385)
	if ((tmp22)){
		HX_STACK_LINE(387)
		{
			HX_STACK_LINE(387)
			bool tmp23 = rect->_weak;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(387)
			if ((tmp23)){
				HX_STACK_LINE(387)
				bool tmp24 = rect->_inPool;		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(387)
				...
				if ((tmp25)){
					...
					HX_STACK_LINE(387)
					::flixel::math::FlxRect tmp27 = rect;		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(387)
					tmp26->putUnsafe(tmp27);
				}
			}
		}
		HX_STACK_LINE(388)
		::flixel::math::FlxRect tmp23 = result;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(388)
		return tmp23;
	}
	HX_STACK_LINE(391)
	...
	HX_STACK_LINE(392)
	{
		...
		result->y = y0;
		HX_STACK_LINE(392)
		Float tmp24 = (x1 - x0);		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(392)
		result->width = tmp24;
		HX_STACK_LINE(392)
		Float tmp25 = (y1 - y0);		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(392)
		result->height = tmp25;
		HX_STACK_LINE(392)
		tmp23 = result;
...
::String FlxRect_obj::toString( ){
	HX_STACK_FRAME("flixel.math.FlxRect","toString",0x7047e358,"flixel.math.FlxRect.toString","flixel/math/FlxRect.hx",399,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(401)
...
Float FlxRect_obj::get_left( ){
	HX_STACK_FRAME("flixel.math.FlxRect","get_left",0xff43d63c,"flixel.math.FlxRect.get_left","flixel/math/FlxRect.hx",408,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(409)
	Float tmp = this->x;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(409)
...
Float FlxRect_obj::get_right( ){
	HX_STACK_FRAME("flixel.math.FlxRect","get_right",0xd324ac07,"flixel.math.FlxRect.get_right","flixel/math/FlxRect.hx",419,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(420)
	Float tmp = this->x;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(420)
...
Float FlxRect_obj::get_top( ){
	HX_STACK_FRAME("flixel.math.FlxRect","get_top",0x81be1600,"flixel.math.FlxRect.get_top","flixel/math/FlxRect.hx",430,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(431)
...
Float FlxRect_obj::get_bottom( ){
	HX_STACK_FRAME("flixel.math.FlxRect","get_bottom",0x04446c60,"flixel.math.FlxRect.get_bottom","flixel/math/FlxRect.hx",441,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(442)
	Float tmp = this->y;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(442)
...
bool FlxRect_obj::get_isEmpty( ){
	HX_STACK_FRAME("flixel.math.FlxRect","get_isEmpty",0x5fa91f2e,"flixel.math.FlxRect.get_isEmpty","flixel/math/FlxRect.hx",452,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(453)
...
::flixel::util::IFlxPool FlxRect_obj::get_pool( ){
	HX_STACK_FRAME("flixel.math.FlxRect","get_pool",0x01f04f11,"flixel.math.FlxRect.get_pool","flixel/math/FlxRect.hx",457,0x2aef791c)
	HX_STACK_LINE(458)
