...
struct _Function_0_1{
	inline static ::flixel::input::gamepad::FlxGamepadAnalogStick Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/LogitechID.hx",57,0xeed1fefa)
		{
			struct _Function_1_1{
				inline static Dynamic Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/LogitechID.hx",57,0xeed1fefa)
					{
						...
						__result->Add(HX_HCSTRING("up","\x5b","\x66","\x00","\x00") , (int)24,false);
						__result->Add(HX_HCSTRING("down","\x62","\xf8","\x6d","\x42") , (int)25,false);
						__result->Add(HX_HCSTRING("left","\x07","\x08","\xb0","\x47") , (int)26,false);
						__result->Add(HX_HCSTRING("right","\xdc","\x0b","\x64","\xe9") , (int)27,false);
						return __result;
					}
					return null();
				}
...
struct _Function_0_2{
	inline static ::flixel::input::gamepad::FlxGamepadAnalogStick Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/LogitechID.hx",58,0xeed1fefa)
		{
			struct _Function_1_1{
				inline static Dynamic Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/LogitechID.hx",58,0xeed1fefa)
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_HCSTRING("up","\x5b","\x66","\x00","\x00") , (int)28,false);
						__result->Add(HX_HCSTRING("down","\x62","\xf8","\x6d","\x42") , (int)29,false);
						__result->Add(HX_HCSTRING("left","\x07","\x08","\xb0","\x47") , (int)30,false);
						__result->Add(HX_HCSTRING("right","\xdc","\x0b","\x64","\xe9") , (int)31,false);
						return __result;
					}
					return null();
				}
