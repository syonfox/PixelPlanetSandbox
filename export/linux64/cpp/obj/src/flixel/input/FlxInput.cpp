...
bool FlxInput_obj::hasState( int state){
	HX_STACK_FRAME("flixel.input.FlxInput","hasState",0x15827bb7,"flixel.input.FlxInput.hasState","flixel/input/FlxInput.hx",53,0xe8bdaaee)
	HX_STACK_THIS(this)
...
bool FlxInput_obj::get_justReleased( ){
	HX_STACK_FRAME("flixel.input.FlxInput","get_justReleased",0x305322f2,"flixel.input.FlxInput.get_justReleased","flixel/input/FlxInput.hx",64,0xe8bdaaee)
	HX_STACK_THIS(this)
	HX_STACK_LINE(65)
	int tmp = this->current;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(65)
...
bool FlxInput_obj::get_released( ){
	HX_STACK_FRAME("flixel.input.FlxInput","get_released",0x4d112826,"flixel.input.FlxInput.get_released","flixel/input/FlxInput.hx",69,0xe8bdaaee)
	HX_STACK_THIS(this)
	HX_STACK_LINE(70)
	int tmp = this->current;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(70)
...
bool FlxInput_obj::get_pressed( ){
	HX_STACK_FRAME("flixel.input.FlxInput","get_pressed",0x1bddd359,"flixel.input.FlxInput.get_pressed","flixel/input/FlxInput.hx",74,0xe8bdaaee)
	HX_STACK_THIS(this)
	HX_STACK_LINE(75)
	int tmp = this->current;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(75)
...
bool FlxInput_obj::get_justPressed( ){
	HX_STACK_FRAME("flixel.input.FlxInput","get_justPressed",0xfa72360d,"flixel.input.FlxInput.get_justPressed","flixel/input/FlxInput.hx",79,0xe8bdaaee)
	HX_STACK_THIS(this)
	HX_STACK_LINE(80)
	int tmp = this->current;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(80)
