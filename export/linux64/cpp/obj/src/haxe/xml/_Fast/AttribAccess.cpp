...
{
HX_STACK_FRAME("haxe.xml._Fast.AttribAccess","new",0x8109dad2,"haxe.xml._Fast.AttribAccess.new","/usr/share/haxe/std/haxe/xml/Fast.hx",48,0xf81b771c)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(48)
...
::String AttribAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.xml._Fast.AttribAccess","resolve",0x20913e5e,"haxe.xml._Fast.AttribAccess.resolve","/usr/share/haxe/std/haxe/xml/Fast.hx",51,0xf81b771c)
	HX_STACK_THIS(this)
