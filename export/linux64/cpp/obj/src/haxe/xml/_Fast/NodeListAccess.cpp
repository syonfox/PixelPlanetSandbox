...
{
HX_STACK_FRAME("haxe.xml._Fast.NodeListAccess","new",0x22c8c708,"haxe.xml._Fast.NodeListAccess.new","/usr/share/haxe/std/haxe/xml/Fast.hx",97,0xf81b771c)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(97)
...
::List NodeListAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.xml._Fast.NodeListAccess","resolve",0x21d97d94,"haxe.xml._Fast.NodeListAccess.resolve","/usr/share/haxe/std/haxe/xml/Fast.hx",100,0xf81b771c)
	HX_STACK_THIS(this)
