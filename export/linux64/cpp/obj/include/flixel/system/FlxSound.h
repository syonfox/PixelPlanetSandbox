...
class HXCPP_CLASS_ATTRIBUTES  FlxSound_obj : public ::flixel::FlxBasic_obj{
	...
	public:
		...
		virtual ::flixel::_system::FlxSound init( hx::Null< bool >  Looped,hx::Null< bool >  AutoDestroy,Dynamic OnComplete);
		Dynamic init_dyn();
		...
		virtual ::flixel::_system::FlxSound play( hx::Null< bool >  ForceRestart,hx::Null< Float >  StartTime,Dynamic EndTime);
		Dynamic play_dyn();
